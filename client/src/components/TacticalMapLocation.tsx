...
const getColor = (type: string, location: any) => {
  const colors = {
    'friendly-main': 'text-blue-500 bg-blue-100',
    'friendly-flank': 'text-blue-600 bg-blue-200',
    'friendly-farm': 'text-green-600 bg-green-200',
    'friendly-boat': 'text-cyan-600 bg-cyan-200',
    'friendly-garage': 'text-indigo-600 bg-indigo-200',
    'enemy-small': 'text-red-500 bg-red-100',
    'enemy-medium': 'text-red-600 bg-red-200',
    'enemy-large': 'text-red-700 bg-red-300',
    'enemy-flank': 'text-orange-600 bg-orange-200',
    'enemy-tower': 'text-purple-600 bg-purple-200',
    'enemy-farm': 'text-yellow-600 bg-yellow-200',
    'enemy-decaying': 'text-gray-500 bg-gray-200',
    'report-pvp': 'text-red-600 bg-red-200',
    'report-spotted': 'text-yellow-600 bg-yellow-200',
    'report-bradley': 'text-purple-600 bg-purple-200',
    'report-oil': 'text-blue-600 bg-blue-200',
    'report-monument': 'text-green-600 bg-green-200',
    'report-farming': 'text-orange-600 bg-orange-200',
    'report-loaded': 'text-pink-600 bg-pink-200',
    'report-raid': 'text-red-700 bg-red-300'
  }
  return colors[type] || 'text-gray-600 bg-gray-200'
}
