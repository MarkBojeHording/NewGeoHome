...
export default function ReportModal({
  ...
  useEffect(() => {
    if (editingReport) {
      setFormData({
        ...
        reportType: editingReport.reportType || reportType,
        locationName: editingReport.locationName || locationName,
        locationCoords: editingReport.locationCoords || locationCoords,
  ...
  }, [editingReport, locationName, locationCoords, reportType]);
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {locationName && (
              <div>
                ...
                <input
                  type="text"
                  value={`${locationName} ${locationCoords ? `(${locationCoords})` : ""}`}
                  readOnly
