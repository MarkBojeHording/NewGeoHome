...
const BaseModal = ({ 
  ...
  const renderReportModal = () => (
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4" style={{ height: '200px' }}>
        {/* Enemy Players */}
        <div className="col-span-2 bg-gray-900 border border-red-500 rounded p-1 flex flex-col relative">
        ...
        {/* Friendly Players */}
        <div className="col-span-1 bg-gray-900 border border-green-500 rounded p-3 flex flex-col h-32">
