    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 font-mono">
      <div className="relative">
        <div className="relative">
          ...
          <div className="bg-gray-900 rounded-lg shadow-xl w-full mx-4 border-2 border-orange-600/50 flex flex-col relative" style={{height: '95vh', maxHeight: '805px', maxWidth: '620px', zIndex: 50}}>
