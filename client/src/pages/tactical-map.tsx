  ...
  return (
    ...
    >
      ...
      {location.type.startsWith('report') ? (
        ...
        <div className="absolute -top-8 -right-8" style={{width: '360px', height: '360px'}}>
          <div style={{transform: 'scale(0.6)', transformOrigin: 'center', width: '600px', height: '600px', marginTop: '-120px', marginLeft: '-120px'}}>
            <RadialMenu />
          </div>
        </div>
      ) : (
