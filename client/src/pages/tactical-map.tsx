  ...
  return (
    ...
    >
      ...
      {location.type.startsWith('report') ? (
        ...
        <div className="absolute -top-2 -right-2" style={{width: '120px', height: '120px'}}>
          <div style={{transform: 'scale(0.2)', transformOrigin: 'center', width: '600px', height: '600px', marginTop: '-240px', marginLeft: '-240px'}}>
            <RadialMenu />
          </div>
        </div>
      ) : (
